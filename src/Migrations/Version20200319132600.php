 ...
 */
final class Version20200319132600 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE animal CHANGE name name VARCHAR(100) DEFAULT NULL, CHANGE identification identification VARCHAR(255) DEFAULT NULL, CHANGE area area VARCHAR(255) DEFAULT NULL, CHANGE city city VARCHAR(100) NOT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
